...
document.write('\
        <script id="fragmentShaderEncryptionAddition677" type="x-shader/x-fragment">\
			uniform sampler2D sTexture;\
			uniform float message[677];\
					...
					void main() {\
						...
						vec4 inputTextureAtThisPixel = texture2D(sTexture,vec2(gl_FragCoord.x/677.0,0.5));\
