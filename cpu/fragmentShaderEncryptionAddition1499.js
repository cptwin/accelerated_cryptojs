...
document.write('\
        <script id="fragmentShaderEncryptionAddition1499" type="x-shader/x-fragment">\
			uniform sampler2D sTexture;\
			uniform float message[1499];\
					...
					void main() {\
						...
						vec4 inputTextureAtThisPixel = texture2D(sTexture,vec2(gl_FragCoord.x/1499.0,0.5));\
