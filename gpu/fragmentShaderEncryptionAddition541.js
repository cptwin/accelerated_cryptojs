...
document.write('\
        <script id="fragmentShaderEncryptionAddition541" type="x-shader/x-fragment">\
			uniform sampler2D sTexture;\
			uniform float message[541];\
					...
					void main() {\
						...
						vec4 inputTextureAtThisPixel = texture2D(sTexture,vec2(gl_FragCoord.x/541.0,0.5));\
