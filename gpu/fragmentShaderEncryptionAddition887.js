...
document.write('\
        <script id="fragmentShaderEncryptionAddition887" type="x-shader/x-fragment">\
			uniform sampler2D sTexture;\
			uniform float message[887];\
					...
					void main() {\
						...
						vec4 inputTextureAtThisPixel = texture2D(sTexture,vec2(gl_FragCoord.x/887.0,0.5));\
