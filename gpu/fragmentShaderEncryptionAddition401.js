...
document.write('\
        <script id="fragmentShaderEncryptionAddition401" type="x-shader/x-fragment">\
			uniform sampler2D sTexture;\
			uniform float message[401];\
					...
					void main() {\
						...
						vec4 inputTextureAtThisPixel = texture2D(sTexture,vec2(gl_FragCoord.x/401.0,0.5));\
