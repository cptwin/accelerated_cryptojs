...
document.write('\
        <script id="fragmentShaderEncryptionAddition1087" type="x-shader/x-fragment">\
			uniform sampler2D sTexture;\
			uniform float message[1087];\
					...
					void main() {\
						...
						vec4 inputTextureAtThisPixel = texture2D(sTexture,vec2(gl_FragCoord.x/1087.0,0.5));\
